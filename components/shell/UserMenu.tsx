 ...
 *
 * Theme switching used to live here too, as a quick light/dark flip plus a
 * "Match system" escape hatch. Removed: the app then had two different
 * controls for one setting, and this one was the lesser of them — a binary
 * toggle sitting next to Sign out, while Settings > Appearance holds the
 * real three-way System/Light/Dark control. Two entry points that disagree
 * about what the setting even is confuse more than the extra click saves.
 * ThemeToggle (components/shell/ThemeToggle) is now the only in-app control;
 * the public landing page keeps its own one-click toggle, which is a
 * different context with no settings screen to point at.
 *
